...
* https://github.com/devonfw/IDEasy/issues/2103[#2103]: Integrate Obsidian
...
* https://github.com/devonfw/IDEasy/issues/2366[#2366]: Support for variables and expressions in repository properties
* https://github.com/devonfw/IDEasy/issues/989[#989]: Allow expressions in template variable definitions
* https://github.com/devonfw/IDEasy/issues/1808[#1808]: Clarify the selected workspace in `ide` and `icd` messages
...
* https://github.com/devonfw/IDEasy/issues/2431[#2431]: Improve uv support to make it usable for IDE_ROOT on non-default drive
* https://github.com/devonfw/IDEasy/issues/2393[#2393]: Open a project folder of my choice (`--project`) instead of always the main workspace (IntelliJ, Android Studio, PyCharm, VS Code)
...
* https://github.com/devonfw/IDEasy/issues/2312[#2312]: Fix NPE in Uv.setEnvironment and suppress errors during auto-completion
...
* https://github.com/devonfw/IDEasy/issues/2180[#2180]: Add *_EXTRA_PLUGINS variable to install extra IDE plugins per user
...
* https://github.com/devonfw/IDEasy/issues/2351[#2351]: Fixed GUI not launching with local dev build
...
* https://github.com/devonfw/IDEasy/issues/1987[#1987]: Fixed issue that the GUI would not launch in SNAPSHOT versions.
...
* https://github.com/devonfw/IDEasy/issues/2218[#2218]: Add missing 3rd party libs to LICENSE
...
* https://github.com/devonfw/IDEasy/issues/2264[#2264]: ide «tool» does not set the environment variables of the other installed tools
